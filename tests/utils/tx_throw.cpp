...
namespace TTX {
  TEST_CASE("TxBlock (Throw)", "[utils][tx]") {
    SECTION("Tx is not a list") {
      ...
      try { TxBlock tx(txStr); } catch (std::exception &e) { catched = true; }
    ...
    SECTION("Tx RLP too short/large") {
      ...
      try { TxBlock txShort(txShortStr); } catch (std::exception &e) { catch1 = true; }
      try { TxBlock txLarge(txLargeStr); } catch (std::exception &e) { catch2 = true; }
      REQUIRE(catch1 == true);
      REQUIRE(catch2 == true);
    }
    ...
    SECTION("Tx to with wrong size") {
      ...
      try { TxBlock tx1(txBiggerStr); } catch (std::exception &e) { catch1 = true; }
      try { TxBlock tx2(txSmallerStr); } catch (std::exception &e) { catch2 = true; }
      REQUIRE(catch1 == true);
      REQUIRE(catch2 == true);
    }
    ...
    */
    ...
    SECTION("Tx invalid signature (wrong elliptic curve)") {
      ...
      try { TxBlock txR(txWrongRStr); } catch (std::exception &e) { catch1 = true; }
      try { TxBlock txS(txWrongSStr); } catch (std::exception &e) { catch2 = true; }
      REQUIRE(catch1 == true);
      REQUIRE(catch2 == true);
    }
  ...
  TEST_CASE("TxValidator (Throw)", "[utils][tx]") {
    SECTION("Tx is not a list") {
      ...
      try { TxValidator tx(txStr); } catch (std::exception &e) { catched = true; }
      REQUIRE(catched == true);
    }
    ...
    SECTION("Tx RLP too short/large") {
      ...
      try { TxValidator txShort(txShortStr); } catch (std::exception &e) { catch1 = true; }
      try { TxValidator txLarge(txLargeStr); } catch (std::exception &e) { catch2 = true; }
      REQUIRE(catch1 == true);
      REQUIRE(catch2 == true);
    }
    ...
    */
    ...
    SECTION("Tx invalid signature (wrong elliptic curve)") {
      ...
      try { TxValidator txR(txWrongRStr); } catch (std::exception &e) { catch1 = true; }
      try { TxValidator txS(txWrongSStr); } catch (std::exception &e) { catch2 = true; }
      REQUIRE(catch1 == true);
      REQUIRE(catch2 == true);
    }
