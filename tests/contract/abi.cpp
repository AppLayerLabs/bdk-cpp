...
TEST_CASE("ABI Namespace", "[contract][abi]") {
  ...
  SECTION("Encode All") {
    ...
    SECTION("Encode "){
      // This is the funniest tuple of them all. jesus
    ...
    SECTION("Encode td::tuple<std::vector<std::tuple<uint256_t, std::string, uint256_t, std::string>>, std::string, uint256_t, std::vector<std::tuple<uint256_t, std::string, uint256_t, std::string>>>") {
    const auto eS = ABI::Encoder::encodeData<
                                    std::tuple<
                                      std::vector<
