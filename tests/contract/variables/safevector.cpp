...
namespace TSafeVector {
  TEST_CASE("SafeVector Class", "[contract][variables][safevector]") {
    ...
    SECTION("SafeVector insert()") {
      ...
      SafeVector<std::string> safeVectorThreeCommit({"test1", "test2", "test3"});
      REQUIRE(safeVectorThree.size() == 3);
      safeVectorThree.insert(safeVectorThree.cbegin(), "test0");
      ...
      safeVectorThreeCommit.revert();
      REQUIRE(safeVectorThreeCommit.size() == 3);
      safeVectorThreeCommit.insert(safeVectorThree.cbegin(), "test0");
      ...
      safeVectorThreeCommit.revert();
      REQUIRE(safeVectorThreeCommit.size() == 3);
      safeVectorThreeCommit.insert(safeVectorThree.cbegin() + 1, "test0");
      REQUIRE(safeVectorThreeCommit.size() == 4);
      REQUIRE(safeVectorThreeCommit[0] == "test1");
    ...
    SECTION("SafeVector erase(pos)") {
      ...
      SafeVector<std::string> safeVectorThreeCommit({"test1", "test2", "test3"});
      REQUIRE(safeVectorThree.size() == 3);
      safeVectorThree.erase(safeVectorThree.cbegin());
      ...
      safeVectorThreeCommit.revert();
      REQUIRE(safeVectorThreeCommit.size() == 3);
      safeVectorThreeCommit.erase(safeVectorThreeCommit.cbegin());
      REQUIRE(safeVectorThreeCommit.size() == 2);
      REQUIRE(safeVectorThreeCommit[0] == "test2");
      REQUIRE(safeVectorThreeCommit[1] == "test3");
      safeVectorThreeCommit.revert();
      REQUIRE(safeVectorThreeCommit.size() == 3);
      safeVectorThreeCommit.erase(safeVectorThreeCommit.cbegin() + 1);
      REQUIRE(safeVectorThreeCommit.size() == 2);
      REQUIRE(safeVectorThreeCommit[0] == "test1");
      REQUIRE(safeVectorThreeCommit[1] == "test3");
      safeVectorThreeCommit.revert();
    ...
    SECTION("SafeVector erase(first, last)") {
      ...
      safeVectorFive.erase(safeVectorFive.cbegin(), safeVectorFive.cbegin() + 2);
      ...
      safeVectorFiveCommit.erase(safeVectorFiveCommit.cbegin() + 2, safeVectorFiveCommit.cbegin() + 4);
      ...
      safeVectorFiveCommit.erase(safeVectorFiveCommit.cbegin(), safeVectorFiveCommit.cbegin() + 3);
