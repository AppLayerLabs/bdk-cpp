...
#include "../../src/contract/customcontracts.h"
#include "../../src/utils/contractreflectioninterface.h"
#include "../../src/utils/utils.h" //nlohmann::json
#include <filesystem>

TEST_CASE("ContractABIGenerator helper", "[contract][contractabigenerator]") {
  SECTION("ContractABIGenerator writeContractsToJson") {
    REQUIRE(ContractReflectionInterface::writeContractsToJson<ERC20, ERC20Wrapper, NativeWrapper>() == 0);
  ...
  SECTION("ContractABIGenerator check file content ERC20") {
    ...
    REQUIRE(j[5]["outputs"][0]["internalType"] == "bytes");
    REQUIRE(j[5]["outputs"][0]["name"] == "");
    REQUIRE(j[5]["outputs"][0]["type"] == "bytes");
    ...
    REQUIRE(j[8]["outputs"][0]["internalType"] == "bytes");
    REQUIRE(j[8]["outputs"][0]["name"] == "");
    REQUIRE(j[8]["outputs"][0]["type"] == "bytes");
  ...
  SECTION("ContractABIGenerator check file content ERC20Wrapper") {
    ...
    REQUIRE(j[1]["inputs"][0]["name"] == "tokenAddress");
    ...
    REQUIRE(j[2]["inputs"][0]["name"] == "tokenAddress");
    REQUIRE(j[2]["inputs"][0]["type"] == "address");
    REQUIRE(j[2]["inputs"][1]["internalType"] == "address");
    REQUIRE(j[2]["inputs"][1]["name"] == "userAddress");
    ...
    REQUIRE(j[3]["inputs"][0]["name"] == "tokenAddress");
    ...
    REQUIRE(j[5]["type"] == "function");
    REQUIRE(j[5]["inputs"][0]["internalType"] == "address");
    REQUIRE(j[5]["inputs"][0]["name"] == "tokenAddress");
    REQUIRE(j[5]["inputs"][0]["type"] == "address");
