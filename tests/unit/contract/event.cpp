...
namespace TEvent {
  TEST_CASE("Event Class", "[unit][contract][event]") {
    SECTION("EVM Event Constructor") {
    ...
    SECTION("JSON String Constructor") {
      // Copied from above
    ...
    SECTION("Serialization (Normal + RPC)") {
