  ...
  TEST_CASE("Blockchain Class", "[core][blockchain]") {
    ...
    SECTION("Initialize Blockchain Multiple Nodes") {
      std::shared_ptr<const Block> bestBlock;
      {
        ...
        initialize("blockchainInitializeTestNode1", "OrbiterSDK/cpp/linux_x86-64/0.1.2", 8080, 8080, 8080, 8101,
                   PrivKey(), {"127.0.0.1", 8100}, blockchain1);

        std::unique_ptr<Blockchain> blockchain2;
        initialize("blockchainInitializeTestNode2", "OrbiterSDK/cpp/linux_x86-64/0.1.2", 8080, 8080, 8081, 8102,
                   PrivKey(), {"127.0.0.1", 8100}, blockchain2);

        std::unique_ptr<Blockchain> blockchain3;
        initialize("blockchainInitializeTestNode3", "OrbiterSDK/cpp/linux_x86-64/0.1.2", 8080, 8080, 8082, 8103,
                   PrivKey(), {"127.0.0.1", 8100}, blockchain3);

        std::unique_ptr<Blockchain> blockchain4;
        initialize("blockchainInitializeTestNode4", "OrbiterSDK/cpp/linux_x86-64/0.1.2", 8080, 8080, 8083, 8104,
    ...
    SECTION("Blockchain multiple nodes, move 10 blocks forward 1 tx per block.") {
      ...
      /// Create the discovery node.
      {
        ...
        initialize("blockchainMove10BlocksTestValidator1", "OrbiterSDK/cpp/linux_x86-64/0.1.2", 8080, 8080, 8080, 8101,
        ...
        initialize("blockchainMove10BlocksTestValidator2", "OrbiterSDK/cpp/linux_x86-64/0.1.2", 8080, 8080, 8081, 8102,
        ...
        initialize("blockchainMove10BlocksTestValidator3", "OrbiterSDK/cpp/linux_x86-64/0.1.2", 8080, 8080, 8082, 8103,
        ...
        initialize("blockchainMove10BlocksTestValidator4", "OrbiterSDK/cpp/linux_x86-64/0.1.2", 8080, 8080, 8083, 8104,
        ...
        initialize("blockchainMove10BlocksTestValidator5", "OrbiterSDK/cpp/linux_x86-64/0.1.2", 8080, 8080, 8084, 8105,
        ...
        initialize("blockchainMove10BlocksTestNode1", "OrbiterSDK/cpp/linux_x86-64/0.1.2", 8080, 8080, 8085, 8106,
                   PrivKey(), {"127.0.0.1", 8100}, blockchainNode1);

        std::unique_ptr<Blockchain> blockchainNode2;
        initialize("blockchainMove10BlocksTestNode2", "OrbiterSDK/cpp/linux_x86-64/0.1.2", 8080, 8080, 8086, 8107,
                   PrivKey(), {"127.0.0.1", 8100}, blockchainNode2);

        std::unique_ptr<Blockchain> blockchainNode3;
        initialize("blockchainMove10BlocksTestNode3", "OrbiterSDK/cpp/linux_x86-64/0.1.2", 8080, 8080, 8087, 8108,
                   PrivKey(), {"127.0.0.1", 8100}, blockchainNode3);

        std::unique_ptr<Blockchain> blockchainNode4;
        initialize("blockchainMove10BlocksTestNode4", "OrbiterSDK/cpp/linux_x86-64/0.1.2", 8080, 8080, 8088, 8109,
                   PrivKey(), {"127.0.0.1", 8100}, blockchainNode4);

        std::unique_ptr<Blockchain> blockchainNode5;
        initialize("blockchainMove10BlocksTestNode5", "OrbiterSDK/cpp/linux_x86-64/0.1.2", 8080, 8080, 8089, 8110,
                   PrivKey(), {"127.0.0.1", 8100}, blockchainNode5);

        std::unique_ptr<Blockchain> blockchainNode6;
        initialize("blockchainMove10BlocksTestNode6", "OrbiterSDK/cpp/linux_x86-64/0.1.2", 8080, 8080, 8090, 8111,
