...
namespace TState {
  ...
  TEST_CASE("State Class", "[core][state]") {
    ...
    SECTION("State test with networking capabilities, 8 nodes, rdPoS fully active, no transactions") {
      ...
      {
        REQUIRE(blockchainWrapper1.storage.getBlock(i)->hash() == blockchainWrapper2.storage.getBlock(i)->hash());
        REQUIRE(blockchainWrapper1.storage.getBlock(i)->hash() == blockchainWrapper3.storage.getBlock(i)->hash());
        REQUIRE(blockchainWrapper1.storage.getBlock(i)->hash() == blockchainWrapper4.storage.getBlock(i)->hash());
        REQUIRE(blockchainWrapper1.storage.getBlock(i)->hash() == blockchainWrapper5.storage.getBlock(i)->hash());
        REQUIRE(blockchainWrapper1.storage.getBlock(i)->hash() == blockchainWrapper6.storage.getBlock(i)->hash());
        REQUIRE(blockchainWrapper1.storage.getBlock(i)->hash() == blockchainWrapper7.storage.getBlock(i)->hash());
        REQUIRE(blockchainWrapper1.storage.getBlock(i)->hash() == blockchainWrapper8.storage.getBlock(i)->hash());
      }
