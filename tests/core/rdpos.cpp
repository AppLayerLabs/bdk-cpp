...
void initialize(std::unique_ptr<DB>& db, 
  ...
  if (clearDb) {
    ...
    std::cout << genesis.getBlockRandomness().hex() << std::endl;
    ...
    db->put(Utils::uint64ToBytes(0), Address(Hex::toBytes("1531bfdf7d48555a0034e4647fa46d5a04c002c3"), true).get(), DBPrefix::validators);
    // PrivateKey: b254f12b4ca3f0120f305cabf1188fe74f0bd38e58c932a3df79c4c55df8fa66
    db->put(Utils::uint64ToBytes(1), Address(Hex::toBytes("e3dff2cc3f367df7d0254c834a0c177064d7c7f5"), true).get(), DBPrefix::validators);
    // PrivateKey: 8a52bb289198f0bcf141688a8a899bf1f04a02b003a8b1aa3672b193ce7930da
    db->put(Utils::uint64ToBytes(2), Address(Hex::toBytes("24e10d8ebe80abd3d3fddd89a26f08f3888d1380"), true).get(), DBPrefix::validators);
    // PrivateKey: 9048f5e80549e244b7899e85a4ef69512d7d68613a3dba828266736a580e7745
    db->put(Utils::uint64ToBytes(3), Address(Hex::toBytes("b5f7152a2589c6cc2535c5facedfc853194d60a5"), true).get(), DBPrefix::validators);
    // PrivateKey: 0b6f5ad26f6eb79116da8c98bed5f3ed12c020611777d4de94c3c23b9a03f739
    db->put(Utils::uint64ToBytes(4), Address(Hex::toBytes("098ff62812043f5106db718e5c4349111de3b6b4"), true).get(), DBPrefix::validators);
    // PrivateKey: a69eb3a3a679e7e4f6a49fb183fb2819b7ab62f41c341e2e2cc6288ee22fbdc7
    db->put(Utils::uint64ToBytes(5), Address(Hex::toBytes("50d2ce9815e0e2354de7834f6fdd4d6946442a24"), true).get(), DBPrefix::validators);
    // PrivateKey: d9b0613b7e4ccdb0f3a5ab0956edeb210d678db306ab6fae1e2b0c9ebca1c2c5
    db->put(Utils::uint64ToBytes(6), Address(Hex::toBytes("7c2b2a0a75e10b49e652d99bba8afee3a6bc78dd"), true).get(), DBPrefix::validators);
    // PrivateKey: 426dc06373b694d8804d634a0fd133be18e4e9bcbdde099fce0ccf3cb965492f
    db->put(Utils::uint64ToBytes(7), Address(Hex::toBytes("6e67067edc1b4837b67c0b1def689eddee257521"), true).get(), DBPrefix::validators);
  }
