...
# To get rid of the generated cc and h files just use the global clean target instead e.g.
#
#   cmake --build . --target clean
#
# The above will clean up everything, but the build is going to get much faster anyway
#  with our new dependency management system.
# Also there is usually no need to recompile the proto files anyway, they don't change.
# This was mostly for when we were fixing the code generation.
#
...
# FIXME: use the clean target instead, remove this NOP command
#
...
#
# note that we are bundling the gRPC lib and its dependencies here with the CometBFT v1 C++ .proto code
# this is what is in the gRPC cpp examples, but we can push those to the BDK lib target_link_libraries instead
