...
namespace DBPrefix {
//const Bytes blocks =             { 0x00, 0x01 }; ///< "blocks" = "0001" -- unused
//const Bytes heightToBlock =      { 0x00, 0x02 }; ///< "heightToBlock" = "0002" -- unused
  const Bytes nativeAccounts =     { 0x00, 0x03 }; ///< "nativeAccounts" = "0003"
//const Bytes txToBlock =          { 0x00, 0x04 }; ///< "txToBlock" = "0004" -- unused
//const Bytes rdPoS =              { 0x00, 0x05 }; ///< "rdPoS" = "0005" -- unused
