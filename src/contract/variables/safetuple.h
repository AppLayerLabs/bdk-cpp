...
/**
* Forward declaration of SafeTuple.
* @see SafeTuple
*/
...
/**
* Non-member get function for SafeTuple.
* @see SafeTuple
*/
template<std::size_t I, typename... Types>
decltype(auto) get(const SafeTuple<Types...>& st);

/**
* Non-member get function for SafeTuple (non-const version)
* @see SafeTuple
*/
template<std::size_t I, typename... Types>
decltype(auto) get(SafeTuple<Types...>& st);
...
public:
    ...
    */
    template<typename... U>
    SafeTuple(const std::tuple<U...>& tpl) : tuple_(tpl) {}
    ...
    */
    template<typename... U>
    SafeTuple(std::tuple<U...>&& tpl) : tuple_(std::move(tpl)) {}
    ...
    */
    SafeTuple& operator=(const SafeTuple& other) {
        ...
        if (other.tuplePtr_) {
            ...
            tuplePtr_ = std::make_unique<std::tuple<Types...>>(other.tuple_);
        }
    ...
    */
    ...
    if (!tuplePtr_) {
        tuplePtr_ = std::make_unique<std::tuple<Types...>>(std::move(other.tuple_));
    }
    return *this;
    }
    ...
    */
    template<typename... OtherTypes>
    SafeTuple& operator=(const SafeTuple<OtherTypes...>& other) {
        check();
        markAsUsed();
        if (other.tuplePtr_) {
            tuplePtr_ = std::make_unique<std::tuple<Types...>>(*other.tuplePtr_);
    ...
    */
    template<typename U, typename V>
    SafeTuple& operator=(const std::pair<U, V>& pair) {
        check();
        markAsUsed();
...
*/
template<typename... Types>
void swap(SafeTuple<Types...>& lhs, SafeTuple<Types...>& rhs) noexcept {
    lhs.check();
    rhs.check();
    lhs.markAsUsed();
    rhs.markAsUsed();
