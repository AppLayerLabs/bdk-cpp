...
/// Variant of SnailTracer that uses int64 instead of int256
class SnailTracerOptimized : public DynamicContract {
  private:
    ...
    using SVector = SafeTuple<int64_t, int64_t, int64_t>; ///< SafeVar version of Vector.
    using SRay = SafeTuple<Vector, Vector, int64_t, bool>; ///< SafeVar version of Ray.
    ...
    SafeInt64_t width_; ///< Width of the image to be generated (fixed for life).
    SafeInt64_t height_; ///< Height of the image to be generated (fixed for life).
  ...
  public:
    ...
    using ConstructorArguments = std::tuple<int64_t, int64_t>;
     ...
     */
    std::tuple<uint8_t, uint8_t, uint8_t> TracePixel(const int64_t& x, const int64_t& y, const uint64_t& spp);
     ...
     */
    Bytes TraceScanline(const int64_t& y, const int64_t& spp);
     ...
     */
    Bytes TraceImage(const int64_t& spp);
     ...
     */
    Vector trace(const int64_t& x, const int64_t& y, const int64_t& spp);
     ...
     */
    Vector mul(const Vector& v, const int64_t& m);
     ...
     */
    Vector div(const Vector& v, const int64_t& d);
     ...
     */
    int64_t dot(const Vector& u, const Vector& v);
     ...
     */
    int64_t intersect(const Sphere& s, const Ray& r);
     ...
     * @return The distance until the first intersection point, or zero in case of no intersection.
     */
    int64_t intersect(const Triangle& t, const Ray& r);
     ...
     * @return A vector representing the radiance.
     */
    Vector radiance(const Ray& ray, const Sphere& obj, const int64_t& dist);
     ...
     * @return A vector representing the radiance.
     */
    Vector radiance(const Ray& ray, const Triangle& obj, const int64_t& dist);
     ...
     */
    std::tuple<int64_t, Primitive, uint64_t> traceray(const Ray& ray);

    /// Register the contract structure.
    static void registerContract() {
      ContractReflectionInterface::registerContractMethods<
        SnailTracerOptimized, int64_t&, int64_t&,
      ...
      >(
        ...
        std::make_tuple("clamp", static_cast<int64_t(SnailTracerOptimized::*)(const int64_t&)>(&SnailTracerOptimized::clamp), FunctionTypes::NonPayable, std::vector<std::string>{"x"}),
        ...
        std::make_tuple("mul", static_cast<Vector(SnailTracerOptimized::*)(const Vector&,const int64_t&)>(&SnailTracerOptimized::mul), FunctionTypes::NonPayable, std::vector<std::string>{"v", "m"}),
        ...
        std::make_tuple("intersect", static_cast<int64_t(SnailTracerOptimized::*)(const Sphere&, const Ray&)>(&SnailTracerOptimized::intersect), FunctionTypes::NonPayable, std::vector<std::string>{"s", "r"}),
        std::make_tuple("intersect", static_cast<int64_t(SnailTracerOptimized::*)(const Triangle&, const Ray&)>(&SnailTracerOptimized::intersect), FunctionTypes::NonPayable, std::vector<std::string>{"t", "r"}),
        ...
        std::make_tuple("radiance", static_cast<Vector(SnailTracerOptimized::*)(const Ray&, const Sphere&, const int64_t&)>(&SnailTracerOptimized::radiance), FunctionTypes::NonPayable, std::vector<std::string>{"ray", "obj", "dist"}),
        std::make_tuple("radiance", static_cast<Vector(SnailTracerOptimized::*)(const Ray&, const Triangle&, const int64_t&)>(&SnailTracerOptimized::radiance), FunctionTypes::NonPayable, std::vector<std::string>{"ray", "obj", "dist"}),
