...
ERC721Test::ERC721Test(ContractManagerInterface &interface, const Address &address, DB& db)
: ERC721(interface, address, db), tokenIdCounter_(this), maxTokens_(this), totalSupply_(this)
{
...
: ERC721(erc721name, erc721symbol, interface, address, creator, chainId, db),
