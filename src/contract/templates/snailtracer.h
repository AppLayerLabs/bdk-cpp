...
class SnailTracer : public DynamicContract {
  ...
  public:
     ...
     */
    std::tuple<uint8_t, uint8_t, uint8_t> TracePixel(int256_t x, int256_t y, uint256_t spp);
     ...
     */
    Bytes TraceScanline(int256_t y, int256_t spp);
     ...
     */
    Vector trace(int256_t x, int256_t y, int256_t spp);
     ...
     */
    Vector mul(Vector v, int256_t m);
     ...
     */
    Vector div(Vector v, int256_t d);
     ...
     */
    int256_t dot(Vector u, Vector v);
     ...
     */
    int256_t intersect(Sphere s, Ray r);
     ...
     * @return The distance until the first intersection point, or zero in case of no intersection.
     */
    int256_t intersect(Triangle t, Ray r);
     ...
     * @return A vector representing the radiance.
     */
    Vector radiance(Ray ray, Sphere obj, int256_t dist);
     ...
     * @return A vector representing the radiance.
     */
    Vector radiance(Ray ray, Triangle obj, int256_t dist);
     ...
     */
    Vector diffuse(Ray ray, Vector intersect, Vector normal);
     ...
     */
    Vector specular(Ray ray, Vector intersect, Vector normal);
     ...
     */
    std::tuple<int256_t, Primitive, uint256_t> traceray(Ray ray);
    ...
    static void registerContract() {
      ...
      >(
        ...
        std::make_tuple("clamp", static_cast<int256_t(SnailTracer::*)(int256_t)>(&SnailTracer::clamp), FunctionTypes::NonPayable, std::vector<std::string>{"x"}),
        ...
        std::make_tuple("mul", static_cast<Vector(SnailTracer::*)(Vector,Vector)>(&SnailTracer::mul), FunctionTypes::NonPayable, std::vector<std::string>{"u", "v"}),
        std::make_tuple("mul", static_cast<Vector(SnailTracer::*)(Vector,int256_t)>(&SnailTracer::mul), FunctionTypes::NonPayable, std::vector<std::string>{"v", "m"}),
        ...
        std::make_tuple("clamp", static_cast<Vector(SnailTracer::*)(Vector)>(&SnailTracer::clamp), FunctionTypes::NonPayable, std::vector<std::string>{"v"}),
        std::make_tuple("intersect", static_cast<int256_t(SnailTracer::*)(Sphere,Ray)>(&SnailTracer::intersect), FunctionTypes::NonPayable, std::vector<std::string>{"s", "r"}),
        std::make_tuple("intersect", static_cast<int256_t(SnailTracer::*)(Triangle,Ray)>(&SnailTracer::intersect), FunctionTypes::NonPayable, std::vector<std::string>{"t", "r"}),
        ...
        std::make_tuple("radiance", static_cast<Vector(SnailTracer::*)(Ray,Sphere,int256_t)>(&SnailTracer::radiance), FunctionTypes::NonPayable, std::vector<std::string>{"ray", "obj", "dist"}),
        std::make_tuple("radiance", static_cast<Vector(SnailTracer::*)(Ray,Triangle,int256_t)>(&SnailTracer::radiance), FunctionTypes::NonPayable, std::vector<std::string>{"ray", "obj", "dist"}),
