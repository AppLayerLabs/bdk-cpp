...
class ABCIServer {
  private:
    ...
    std::shared_ptr<ABCINetServer> abciNetServer_; ///< Boost ASIO ABCI stream socket server implementation
  ...
  public:
     ...
     * @param cometUNIXSocketPath Path for the unix:// domain socket that the cometbft client will connect to.
     */
